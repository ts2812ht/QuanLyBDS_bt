            ...
            <div class="row">
               ...
               <main role="main" class="ml-sm-auto col-lg-10">
                  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
                     <h1 class="h1">Sửa tin đăng (Mã tin: #<%=(String)request.getParameter("Pid")%>)</h1>
                  </div>
                  <form class="form-horizontal js-form-submit-data js-frm-manage-post" action="Sua_tin_servlet" enctype="multipart/form-data" method="POST">
                     <div class="row">
                        <div class="col-md-8">
                           <div class="row">
                              <div class="col-md-12">
                           ...
                           <div class="row">
			                    <div class="col-md-6">
			                        <div class="form-group">
			                            ...
			                            <input type="text" class="form-control js-input-street-number" name="address" id="address">
			                        </div>
			                    </div>
			               </div>
                           <div class="row">
                              <div class="col-md-12">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" readonly ="readonly" name="dia_chi" id="diachi">
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="form-group row mt-3">
                              ...
                              <div class="col-md-6">
                                 <select class="form-control" id="post_cat" name="loai_chuyen_muc" readonly="readonly" required data-msg-required="Chưa chọn loại chuyên mục">
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-md-12">
                                 <input type="text" class="form-control" name="post_title" id="post_title" minlength="30" maxlength="120" required data-msg-required="Tiêu đề không được để trống" data-msg-minlength="Tiêu đề quá ngắn" data-msg-maxlength="Tiêu đề quá dài">
                              </div>
                           </div>
                           <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
			                         <div class="user-avatar-upload-wrapper js-one-image-wrapper ">
			                            <div class="user-avatar-upload clearfix">
			                               <input type="file" name="image" id="asdasd" class="btn-add-avatar js-change-image-file"/>
                           ...
                           <input type="hidden" id="Post_id" name="Post_id" class="js-input-value"/>
                           <div class="form-group row mt-5">
                              <div class="col-md-12">
...
<script type="text/javascript">
     $(document).ready(function () {
    	 $.ajax({
             url: "Sua_tin_ajax",
             method: "GET",
             data: {Pid: <%=(String)request.getParameter("Pid")%>},
             success: function (data, textStatus, jqXHR) {
            	 console.log(data);
            	 let obj = $.parseJSON(data);
                 $.each(obj, function (key, value) {
                	$('#district_id').prop('selectedIndex', value.district_id);
					let px_id = value.phuongxa_id;
			    	 $.ajax({
			             url: "Phuongxa_ajax_servlet",
			             method: "GET",
			             data: {id: $('#district_id').val()},
			             success: function (data, textStatus, jqXHR) {
			                 let obj = $.parseJSON(data);
			                 $.each(obj, function (key, value) {
			                	 if  (value.id == px_id){
			                		 $('#phuongxa').append('<option value="' + value.id + '"selected>' + value.name + '</option>');	
			                	 } else{
					...
					$('#diachi').val(value.address);
					$('#post_cat').prop('selectedIndex', value.category_id);
				 	$('#post_title').val('asdsad');
					$('#description').val(value.description);
					$('#giachothue').val(value.price);
					$('#post_acreage').val(value.area);
					$('#old_image').attr("src",value.images);
					$('#Post_id').val(value.id);
                 });
             },
             error: function (jqXHR, textStatus, errorThrown) {
