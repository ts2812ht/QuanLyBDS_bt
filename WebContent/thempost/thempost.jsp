...
<div id="page" class="d-flex">
    ...
    <div class="flex-grow-1">
        ...
        <!--  phần nhét code -->
        <form id="formThem" action="<%= request.getContextPath() %>/them-post" class="form__add-product form-submit" method="POST" enctype="multipart/form-data" autocomplete="off">
                                        ...
                                        <div class="row general-info__basic">
                                            <div class="row">
                                                <div class="atb col-4">
                                                    ...
                                                    <input type="text" id="code" name="code" class="atb-input input-group form-control shadow-none form-control shadow-none" placeholder="Nhập Mã bài viết"  autofocus >
                                                </div>
                                                <div class="atb col-4">
                                                    <span class="atb-name defaultCursor">Tiêu đề<span style="color: red"> *</span></span>
                                                    <input type="text" id="title" name="title" class="atb-input input-group form-control shadow-none form-control shadow-none" placeholder="Nhập Tiêu đề"  autofocus >
                                                </div>
                                                <div class="atb col-4">
                                                    <span class="atb-name defaultCursor">Mô tả<span style="color: red"> *</span></span>
                                                    <input type="text" id="description" name="description" class="atb-input input-group form-control shadow-none" placeholder="Nhập Mô tả" >
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="atb col-4">
                                                    <span class="atb-name defaultCursor">Giá<span style="color: red"> *</span></span>
                                                    <input type="text" id="price" name="price" class="atb-input input-group form-control shadow-none" placeholder="Nhập Giá" >
                                                </div>
                                                <div class="atb col-4">
                                                    <span class="atb-name defaultCursor">Số lượt view<span style="color: red"> *</span></span>
                                                    <input type="text" id="count_view" name="count_view" class="atb-input input-group form-control shadow-none" placeholder="Nhập Số lượt view" >
                                                </div>
                                                <div class="atb col-4">
                                            ...
                                            <div class="row">
                                                <div class="atb col-4">
                                                    ...
                                                    <select name="postcategory" id="postcategory" class="atb-input input-group form-control shadow-none category-select">
                                                ...
                                                <div class="atb col-4">
                                                    ...
                                                    <select name="district" id="district" class="atb-input input-group form-control shadow-none category-select">
